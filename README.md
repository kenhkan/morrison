...
What it does not mean, however, is that the executable generated by compiling a
network of components via the Vyzzi compiler is required to be
AGPLv3-compatible. The licensing of the compiled executable depends solely on
the licenses of the constituent components.
